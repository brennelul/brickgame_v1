/**
 * @file tetris.c
 * @brief Main backend functions of the game
 * @author brennelul
 */
...
/**
 * @ingroup other_funcs
 * @brief All tetrominos
 * @param[in] num Tetromino index
 * @return Returns tetromino struct
 */
 ...
 * @param[in] user_input Input from the user's keyboard
 * @return Returns human-readable signal
 */
